...
const runtimeHelpers = await import(
  pathToFileURL(
    "C:/Users/Jule/.codex/plugins/cache/openai-primary-runtime/presentations/26.826.12353/skills/presentations/container_tools/runtime_helpers.mjs"
  ).href
);
const { importRuntimeModule } = runtimeHelpers;
